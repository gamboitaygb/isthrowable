 ...
 */
final class Version20180824233244 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE like_users (like_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_A3E78C0E859BFA32 (like_id), UNIQUE INDEX UNIQ_A3E78C0EA76ED395 (user_id), PRIMARY KEY(like_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
